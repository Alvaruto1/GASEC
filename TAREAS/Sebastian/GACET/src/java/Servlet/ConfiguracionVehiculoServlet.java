 ...
 * @author alvar
 */
public class ConfiguracionVehiculoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(caso){
            ...
            case 1:
                ...
                response.sendRedirect("editarVehiculo.jsp");
                break;
            // eliminar vehiculo
            case 3:
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConfiguracionVehiculoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ConfiguracionVehiculoServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
